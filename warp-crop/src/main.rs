...
use select_ball::img::crop::{crop, Crop};
use select_ball::img::interpolation::CanLinearInterpolate;
use select_ball::img::registration;
use select_ball::img::viz::IntoGray;
    ...
    I: IntoDMatrix<P, T>,
{
    ...
    if let Some(target) = equalize {
        ...
        select_ball::utils::equalize_mean(target, temp.as_mut_slice());
