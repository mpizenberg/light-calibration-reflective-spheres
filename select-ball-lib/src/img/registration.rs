...
use image::{DynamicImage, GenericImageView, Primitive};
...
// --- ///macro_rules! just_compute_max {
// --- ///    ($config: expr, $imgs: expr, $($should_stop: expr),*) => {{
// --- ///        let imgs_count = $imgs.len();
// --- ///
// --- ///        $(if $should_stop("Precompute", None)
// --- ///                        .await {
// --- ///                            return Err(RegistrationError::StoppedByCaller);
// --- ///                        })*
// --- ///        for im in $imgs.into_iter() {
// --- ///            // We first blur each image
// --- ///            let blured_image = blur(&im, $config.sigma);
...
//     // just_compute_max!(config, imgs, should_stop)
// }
//
...
// }
//
// pub fn warp<T, V, O>(img: &DynamicImage, motion_params: &Vector6<f32>) -> DMatrix<O>
// where
//     O: Scalar,
//     V: Add<Output = V>,
//     f32: Mul<V, Output = V>,
